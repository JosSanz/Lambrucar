...
const OilStationIcon = (props: React.PropsWithoutRef<React.SVGProps<SVGSVGElement>>) => (
    <svg fill="currentcolor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 422.883 422.883" {...props}>
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="transparent" stroke-width="5.920362"></g>
        <g id="SVGRepo_iconCarrier">
            <g>
...
const OilTruckIcon = (props: React.PropsWithoutRef<React.SVGProps<SVGSVGElement>>) => (
    <svg fill="currentcolor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 256 131" enable-background="new 0 0 256 131" transform="matrix(-1, 0, 0, 1, 0, 0)" {...props}>
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
